...
"outLiftPresNoBucket" => [1240.21, 1271.93, 1303.67, 1335.44, 1367.06, 1398.56, 1429.88, 1461.06, 1491.89, 1522.38, 1552.52, 1577.43, 1582.07, 1610.98, 1639.05, 1666.11, 1691.64, 1715.09, 1735.41, 1750.60, 1751.13],
...
# empty bucket weight.
"LiftKpaNoBucketMidExtension" => 1522.80,
...
MachineType = {
  "InternalMsn" => "CAT62100",
  "Make" => "CAT",
  "Model" => "962H",
  "ModelDetail" => "962H",
  "Linkage" => "Standard (SSA/PCW)",
