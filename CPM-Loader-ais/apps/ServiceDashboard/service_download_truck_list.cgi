...
echo "Content-Type:text/csv; charset=utf-8; name=\"TruckList_$datetime.csv\""
echo "Content-Disposition: attachment; filename=\"TruckList_$datetime.csv\""
echo
# Must match path of tempRoot in LpsSaListMgrApp.rb
cat /tmp/appdata/CPM/LpsSaListMgrApp/TruckList.csv
